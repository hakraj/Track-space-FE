    ...
    <>
      <div className="flex flex-col justify-center items-center min-h-screen max-w-xs md:max-w-md mx-auto">
        <div className="w-full text-center mt-[10vh] mb-[20vh]  bg-[#ffffff11] backdrop-filter md:rounded-[2.5rem] shadow-md shadow-violet-300/50 rounded-2xl p-6 md:p-8 drop-shadow-lg">
          ...
          <p className="font-normal mb-8 text-slate-300">Tell us about yourself </p>
          <form className="text-left">
            <div>
              ...
              <div className=" flex items-center justify-between gap-4 md:gap-8">
                ...
                <label htmlFor="firstname">
                  <span className=" font-normal text-sm text-violet-300">Years of experience</span>
                  <input
                    list="yrs"
                    className="mb-3 mt-1 block w-full p-2 border border-gray-300 rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400 focus:invalid:border-red-500 focus:invalid:ring-red-500 bg-white"
                    id="password"
              ...
              <label htmlFor="firstname">
                <span className=" font-normal text-sm text-violet-300">Stack tools e.g Software, Framework</span>
                <input
                  className="mb-3 mt-1 block w-full p-2 border border-gray-300 rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400 focus:invalid:border-red-500 focus:invalid:ring-red-500 bg-white"
                  id="email"
                />
              ...
              <div className=" flex items-center justify-between gap-4 md:gap-8">
                <label htmlFor="firstname">
                  <span className=" font-normal text-sm text-violet-300">Address</span>
                  <input
                    className="mb-3 mt-1 block w-full p-2 border border-gray-300 rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400 focus:invalid:border-red-500 focus:invalid:ring-red-500 bg-white"
                    placeholder="1, Silicon valley"
                    id="email"
                  />
                </label>
                <label htmlFor="firstname">
                ...
                <label htmlFor="firstname">
                  <span className=" font-normal text-sm text-violet-300">Nationality</span>
                  <input
                    list="country"
                    autoComplete="off"
                    className="mb-3 mt-1 block w-full p-2 border border-gray-300 rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400 focus:invalid:border-red-500 focus:invalid:ring-red-500 bg-white"
            ...
            <div className=" flex items-center justify-between">
              <button
                type="reset"
                className=" font-ubuntu my-4 bg-transparent border border-violet-400 hover:text-slate-200 hover:bg-gradient-to-tr hover:from-violet-300 hover:to-violet-400 rounded-lg py-2 px-4 text-lg text-white"
              >
                Reset
              </button>
              <button
                type="submit"
                className=" font-ubuntu  my-4 bg-violet-500 hover:bg-gradient-to-tr hover:from-violet-300 hover:to-violet-400 rounded-lg py-2 px-4 text-lg text-white"
              >
                Submit
              </button>
