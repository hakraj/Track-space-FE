...
const DashboardHome = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#ffffff11] backdrop-filter rounded-2xl px-[5%] py-4 md:py-8 mt-1">
        <form className="text-left flex items-center justify-between">
          ...
          <div>
            <span className=" text-sm align-middle text-slate-400">
              ...
              <span className=" align-text-top">Recent</span>
            </span>
            <span className=" p-2 bg-slate-700 rounded-lg ml-4">
