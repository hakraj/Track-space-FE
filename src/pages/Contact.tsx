    ...
    <>
      <div className="flex flex-col justify-center items-center min-h-screen max-w-sm md:max-w-md mx-auto">
        <div className="w-full text-center mt-[10vh] mb-[20vh]  bg-[#ffffff11] backdrop-filter md:rounded-[2.5rem] shadow-md shadow-violet-300/50 rounded-2xl p-4 lg:p-8 drop-shadow-lg">
          ...
          <h1 className="text-2xl md:text-3xl font-ubuntu font-bold my-6 text-slate-200 light:text-slate-800">
            Contact us
          </h1>
          <p className="font-normal mb-8 text-slate-300">Make your complaint to trackspace team </p>
          <form className="text-left">
            <div>
              <label htmlFor="firstname">
                <span className=" font-normal text-sm text-violet-300">Name</span>
                <input
              ...
              <label htmlFor="firstname">
                <span className=" font-normal text-sm text-violet-300">Message</span>
                <textarea
                  className="mb-3 mt-1 block w-full p-2 border border-gray-300 rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400 focus:invalid:border-red-500 focus:invalid:ring-red-500 bg-white"
